...
$[+0.0451,+0.0564]$, ahead in 14/14 conditions). It is $+0.0804$ on the more
...
training gradient while the study supplies $55.3\%$ of the held-out rows.
...
\textbf{Within condition}, $n$-weighted      & {14} & 0.7605 & 0.8111 & \bfseries +0.0506 & $[+0.0451,+0.0564]$ \\
\bottomrule
\end{tabular}
\begin{tablenotes}[flushleft]\footnotesize
